...
Item {
    ...
    ScrollView
    {
        ...
        Label{
            ...
            anchors.topMargin:8
            text:catalog.i18nc("@tabtitle","Quality:")
            font.bold:true
            }
            ...
            delegate:
                UM.TooltipArea {
                    ...
                    Loader
                    {
                        ...
                        UM.ContainerPropertyProvider { id: containerProvider; containerId: base.containerId; watchedProperties: [ "value" ]; key: model.key }
                        ...
                        Connections
                        {
                            ...
                            onShowTooltip: base.showTooltip(delegate, Qt.point(0, 0), text)
