...
Item {
    ...
    ScrollView
    {
        ...
        Label{
            ...
            anchors.top:parent.top
            anchors.topMargin:8
            text:catalog.i18nc("@tabtitle","Retraction:")
            font.bold:true
            }
        ListView
        {
    ...
    ScrollView
    {
       ...
       Label{
            ...
            anchors.top:parent.top
            anchors.topMargin:8
            text:catalog.i18nc("@tabtitle","Travel:")
            font.bold:true
            }
        ListView
        {
            ...
            model: UM.SettingDefinitionsModel
            {
                ...
                containerId: Cura.MachineManager.activeDefinitionId
                visibilityHandler: UM.SettingPreferenceVisibilityHandler { }
                exclude: ["experimental", "resolution", "infill", "support", "material", "speed", "shell", "cooling", "meshfix", "platform_adhesion", "blackmagic","machine_settings", "command_line_settings", "infill_mesh", "infill_mesh_order", "support_mesh", "anti_overhang_mesh"] // TODO: infill_mesh settigns are excluded hardcoded, but should be based on the fact that settable_globally, settable_per_meshgroup and settable_per_extruder are false.
            }
            ...
            delegate:
                UM.TooltipArea {
                    ...
                    Loader
                    {
                        ...
                        property var definition: model
                        property var settingDefinitionsModel: travelModel
                        ...
                        source:
                        {
                            switch(model.type)
                            {
                                ...
                                case "str":
                                    return "SettingTextField.qml"
                                case "category":
                                    return travelModel.expandAll(model.key)
                                default:
                                    return "SettingUnknown.qml"
                            }
                        }
