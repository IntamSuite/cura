...
Item {
    ...
    ScrollView
    {
        ...
        Label{
            ...
            anchors.top:parent.top
            anchors.topMargin:8
            text:catalog.i18nc("@tabtitle","More:")
            font.bold:true
            }
        ListView
        {
