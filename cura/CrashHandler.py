...
def show(exception_type, value, tb):
    ...
    label.setText(catalog.i18nc("@label", """<p>A fatal exception has occurred that we could not recover from!</p>
        ...
        <p>Please use the information below to post a bug report to email support@intamsys.com</p>
    """))
    ...
    buttons.helpRequested.connect(lambda: webbrowser.open("http://intamsys.com"))
